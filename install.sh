...
echo ""
echo "Next steps:"
echo "  1. Run 'guardrail pentest' to see your guards in action"
echo "  2. Run 'guardrail upgrade --trial' to unlock 48 Pro guards free for 14 days"
echo "  3. Add custom guards to $INSTALL_DIR/guards/custom/"
echo ""
echo "  ${D}The system behind GuardRail:${Z}"
echo "  ${D}\"Runs Without Me\" - amazon.de/dp/B0HDMT162J${Z}"
